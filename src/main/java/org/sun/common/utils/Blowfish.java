...
public class Blowfish {
    ...
    private static BlowfishCBC getMbfish(String password) {
        ...
        BlowfishCBC m_bfish = new BlowfishCBC(digest.digest(), 0L);
        digest.reset();
     ...
     * @return
     */
    public static String encrypt(String password, String sPlainText) {
        long lCBCIV;
        synchronized (m_rndGen) {
            lCBCIV = m_rndGen.nextLong();
        }
        return encStr(password, sPlainText, lCBCIV);
    }

    private static String encStr(String password, String sPlainText, long lNewCBCIV) {
        ...
        BlowfishCBC m_bfish = getMbfish(password);
     ...
     * @return
     */
    public static String decrypt(String password, String sCipherText) {
    ...
    private static void destroy(BlowfishCBC m_bfish) {
        m_bfish.cleanUp();
    }
    ...
    public static void main(String[] args) {
        ...
        String keyWord = "你好吗？";
        String encryptWord = Blowfish.encrypt(password, keyWord);
        String decryptWord = Blowfish.decrypt(password, encryptWord);

        logger.info("keyWord: {}\n encryptWord: {}\n decryptWord: {}", keyWord, encryptWord, decryptWord);
