...
public class AESEncrypter {
    ...
    public static final String PLAIN_TEXT = "77777777777777";
    ...
    public static void main(String[] arg) {
        byte[] secretBytes = Base64Utils.decodeFromString("SJT2Zzz2oTru5X0ksVE8yA==");
        ...
        System.out.println("AES CBC decoded: "
                ...
                IVPARAMETERS));
        System.out.println(generateAESSecretKey());
